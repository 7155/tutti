...
const connectorMarketEn = {
  ...
  actionSaveAgentAccess: "Save Agent access",
  actionRetry: "Retry",
  actionUninstall: "Uninstall",
  actionUpdateAuthorization: "Reauthorize",
  availableTab: "Available",
  agentAccessEmpty: "No Agents are available for authorization",
  agentAccessTitle: "Authorized Agents",
  blockedDescription:
  ...
  description: "Install and authorize external services for selected Agents",
  ...
  dialogManagementDescription:
    "Review installation, authorization, permissions, and Agent access",
  dialogManagementTitle: "{{name}} connector",
  dialogInstallationDescription:
    "Choose which Agents can use this connector. You can change the selection after installation.",
...
const connectorMarketZhCN = {
  ...
  actionManage: "管理",
  actionRefresh: "刷新",
  actionSaveAgentAccess: "保存 Agent 授权",
  actionRetry: "重试",
  actionUninstall: "卸载",
  actionUpdateAuthorization: "重新授权",
  availableTab: "可安装",
  agentAccessEmpty: "当前没有可授权的 Agent",
  agentAccessTitle: "授权给 Agent",
  blockedDescription: "当前环境无法使用这个连接器",
  blockedTitle: "连接器不可用",
  cancel: "取消",
  catalogEmpty: "暂无可用连接器",
  catalogError: "无法加载连接器目录",
  catalogSection: "连接器",
  ...
  description: "安装并授权外部服务，让指定 Agent 安全使用数据与工具",
  ...
  dialogManagementDescription: "查看安装、授权、权限与 Agent 访问状态",
  dialogManagementTitle: "{{name}} 连接器",
  dialogInstallationDescription:
    "选择可以使用这个连接器的 Agent，安装后仍可重新配置。",
