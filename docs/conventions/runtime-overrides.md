...
then projects it to the generic daemon override.
...
| `DEV_GUI_KIMI_CODE_PACKAGE_DIR`           | [Development scripts](../../tools/scripts/README.md)                                  | Selects an intentional local Kimi package for one `make dev-gui` run; unset keeps the signed remote source. |
