...
export const zhCN = {
  ...
  workspace: {
    ...
    agentGui: {
      sessionReplay: {
        ...
        record: {
          ...
          deleteConfirm: "删除",
          deleteDescription:
            "“{{name}}”及其回放数据将被永久删除，此操作无法撤销",
          deleteFailed: "无法删除录制",
          deleteTitle: "删除录制？",
          import: "导入",
          importAllFailed: "{{count}} 个磁带导入失败",
          importFailed: "无法导入磁带",
          importPartial:
            "已导入 {{importedCount}} 个磁带，{{failedCount}} 个失败",
          imported: "已导入 {{count}} 个磁带",
          rename: "重命名录制",
          renameCancel: "取消重命名",
        ...
        replay: {
          ...
          batchCancel: "取消",
          batchLaunch: "回放已选项",
          batchSameSession: "已选择这个会话的另一条录制",
          batchSelect: "选择",
          batchSelectedCount: "已选择 {{count}} 个",
          batchSelectRecording: "选择 {{name}} 进行批量回放",
          cassette: "回放 Cassette",
          checkpoint: "Checkpoint {{current}} / {{total}}",
          choosePlaybackMode: "选择回放模式",
          complete: "校验通过",
          controlFailed: "无法控制回放",
          elapsed: "已回放 {{elapsed}} / {{total}}",
          failed: "校验失败",
          launching: "正在启动独立回放窗口",
          launchingBatch: "正在启动包含 {{count}} 个会话的独立回放窗口",
          manual: "暂停后手动播放",
          next: "下一个 checkpoint",
          opened: "独立回放窗口已打开",
          openedBatch: "已打开包含 {{count}} 个会话的独立回放窗口",
          pause: "暂停回放",
          play: "播放回放",
          replaying: "正在回放",
          speed: "回放速度",
    ...
    agentEnv: {
      ...
      codeBuddyAccountBilling: "CodeBuddy Account",
